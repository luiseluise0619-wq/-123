...
globalThis.MysbizonParts.i18n = {
  ...
  KO_BASE(){
    return {
      ...
      "pop.noteLong": "유동인구는 {dong} 행정동 값입니다. 동네(상권)보다 넓은 단위라 이 자리만의 값은 아닙니다. 상권 좌표를 행정동 경계와 대조해 붙였습니다.",
      ...
      "cmp.diffSales": "손님이 가장 많은 곳은 {a}이에요. 경쟁 가게 수는 {tie}.",
      "cmp.diffStore": "경쟁이 가장 적은 곳은 {b}이에요. 손님 수는 {tie}.",
      ...
      "sido.notYet": "‘{sido}’ 자료는 아직 없습니다. 지금 계산에 쓰는 자료는 서울시 상권분석서비스라 서울 1,564곳만 담고 있습니다. 전국은 소상공인시장진흥공단 상권정보로 갈아타야 하고, 상권 구획과 업종 코드가 달라 매칭이 필요합니다.",
      "pr.spendByGu": "자치구별 ‘{name}’ 지출 비중",
      "rent.refOf": "{name} 기준 (한국부동산원)",
      "rent.perSqm": "{value}/㎡ · {note}",
      "bep.scenNote": "이 동네 {ind} 가게들의 평균만큼 팔린다고 보고 계산합니다.",
      "bep.dayWhy": "본전 {bep} ÷ 30일 ÷ {src} {unit}원. 이 금액은 카드 1건당 결제액이라, 여러 명이 함께 결제하면 실제 손님 수와 결제 건수는 다릅니다. 시간대 비중은 서울 전체 {ind} 평균입니다.",
